...
export interface ApiItemItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    item_status: Schema.Attribute.Enumeration<
      ['active', 'maintenance', 'disposed', 'lost']
    > &
    ...
    maintenance_logs: Schema.Attribute.Relation<
      'oneToMany',
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user_department: Schema.Attribute.String;
  };
}
...
export interface ApiMaintenanceLogMaintenanceLog
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    date_fixed: Schema.Attribute.Date;
    ...
    > &
      Schema.Attribute.Private;
    log_status: Schema.Attribute.Enumeration<['pending', 'resolved']> &
...
export interface ApiTransactionTransaction extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<['issue', 'return', 'adjust']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
